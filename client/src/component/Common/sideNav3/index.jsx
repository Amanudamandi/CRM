...
const Index = ( { department, nameLogo }) => {
    ...
    // const toggleOptions = ( setShowOption, showOption) => {
    ...
    return(
            <nav className='sideNav-container' >
                <section className='menu-container'>
                    ...
                    <Link to='employee/dashboard' className='menu-option'>
                        <FaChartPie color='#fff'/>
                        <span className='option'>Dashboard</span>
                    </Link>

                    <Link to='employee/show-leads' className='menu-option' style={{ width: '100%', position: 'relative', alignItems: 'flex-start'}} onClick={() => {
                        ...
                        <div className='option'>
                            Lead 
                            {
                                showLeadsOptions && <div style={Styles.employeeOptionsContainer}>
                                    <Link to='employee/show-leads/add' className="employee-option" style={Styles.employeeOption}>Add</Link>
                                </div>
                            }
                        </div>
