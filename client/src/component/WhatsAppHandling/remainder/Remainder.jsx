...
export const Remainder = ({ showRemainder, closeForm, data, }) => {
    const Style = {
    ...
    // console.log("data is in a remainder form : ",data);
    ...
    console.log("data from the clicked form : ", dataForm)
    ...
    const handleOnSubmit = async (event) => {
        ...
        formData.append("reminderDays", dataForm.reminderDays);
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_URL}/client/whatappSchdule`, formData,
                {
                    headers: {
                ...
                <form method='POST' action="" style={Style.updateForm} onSubmit={handleOnSubmit} >
                    <div style={Style.leftFormFieldContainer}>
                        <div style={Style.inputFieldContainer}>
                            <label htmlFor="day" style={Style.inputLabel}>Remainder after </label>
                            <input type="number" name="reminderDays" id="day" onChange={handleOnInputChange} />
                        </div>
                        ...
                        <div style={Style.inputFieldContainer}>
                            <button style={Style.updateBtn}>Send Remainder </button>
                        </div>
