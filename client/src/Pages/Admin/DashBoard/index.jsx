    ...
    return (
        <section style={Styles.adminContainer}>
            ...
            <section style={Styles.employeeContainer}>
                ...
                {/* <div style={{ display: 'flex', alignItems: 'center', margin: '0.5rem 1rem' }}> */}
                    {/* <div>
                    ...
                    {/* <div style={{ width: '550px', height: '300px', borderRadius: '0.5rem', padding: '1rem', boxShadow: '0px 0px 6px rgb(120, 120, 120)'}}> */}
                        {/* <Suspense 
                            fallback={<Loader />}
                        > */}
                            {/* <BarChart 
