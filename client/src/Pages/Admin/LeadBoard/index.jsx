...
const Index = () => {
    ...
    const headingList =
        [
           'Stage', 'Coordinator', 'Lead Handler', 'Name', 'Mobile', 'Email' ,'Remainder ', 'State', 'District', 'KWP Interested', 'Source', 'Date', 'Type',"Proposal",'Aadhar Card','Pan Card',"Electricity Bill","Bank Details","CancleCheck","Dimension","Video",
            // "Payment"
        ];
