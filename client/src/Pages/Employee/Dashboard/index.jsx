...
const Index = () => {
    ...
    const callStageCountNnumberOfTimes = async(count, showAllStages) => {
        ...
        for( ; index < count; index++){
            ...
            const leadsValue = await stageCountForDashboardApi(employeeId, stageId);
            const TODAYS = await stageCountForDashboardApi(employeeId, stageId, today.toDateString(), today.toDateString());
            const LAST_WEEK = await stageCountForDashboardApi(employeeId, stageId, lastSevenDays, today.toDateString());
            const LAST_MONTH = await stageCountForDashboardApi(employeeId, stageId, lastSevenDays, today.toDateString());
