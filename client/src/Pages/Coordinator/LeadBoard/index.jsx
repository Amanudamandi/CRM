...
// import { setCookie } from '../../../component/cookieUtils';
...
const Index = () => {
    ...
    const Styles = {
        ...
        employeeTable: { width: '100%', backgroundColor: '#fff', borderRadius: '5px', borderColor: '#ddd', borderCollapse: '' },
        loaderMainContainer: {
            width: '79%',
            height: '91vh',
        },
    ...
    const headingList = 
    [ 
        'Stage', 'Lead Handler', 'Name', 'Mobile', 'Email', 'Type', 'State', 'District', 'KWP Interested', 'Source',
        'Date'
    ];
        ...
        <section style={Styles.adminContainer}>
            ...
            {/* {
                ...
                <section style={{...Styles.employeeContainer, display: (leadClickedInfo.clicked) ? 'none' : 'block'}}>
                    <table style={Styles.employeeTable} rules='rows'>
                        <FixedRow 
                        ...
                        <ShowClickableLeads 
                            ...
                            coordinatorAutoGeneratedID={isAuthenticated.employeeId}
